...
function img1Desc() {
    var img1Desc = prompt("What would you like to change the description to?");
    $('#desc1').html(img1Desc);
}
function img2Desc() {
    var img2Desc = prompt("What would you like to change the description to?");
    $('#desc2').html(img2Desc);
}
function img3Desc() {
    var img3Desc = prompt("What would you like to change the description to?");
    $('#desc3').html(img3Desc);
}
function img4Desc() {
    var img4Desc = prompt("What would you like to change the description to?");
    $('#desc4').html(img4Desc);
}
function img5Desc() {
    var img5Desc = prompt("What would you like to change the description to?");
    $('#desc5').html(img5Desc);
}
function img6Desc() {
    var img6Desc = prompt("What would you like to change the description to?");
    $('#desc6').html(img6Desc);
}
function img7Desc() {
    var img7Desc = prompt("What would you like to change the description to?");
    $('#desc7').html(img7Desc);
}
function img8Desc() {
    var img8Desc = prompt("What would you like to change the description to?");
    $('#desc8').html(img8Desc);
}
function img9Desc() {
    var img9Desc = prompt("What would you like to change the description to?");
    $('#desc9').html(img9Desc);
}
var main = function() {
    $("#img1").click(function() {
